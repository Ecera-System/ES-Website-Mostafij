                        ...
                        <ul className='flex flex-col gap-y-4'>
                            {
                                faq1.map((item, index) => <li key={index}>
                                    <button
                                        ...
                                        className={`text-start flex items-center justify-between w-full text-gray-600 text-xl font-medium py-4 px-5 hover:text-gray-200 hover:bg-[#021D40] duration-300 ${faqIndex1 === index ? 'bg-[#021D40] text-gray-200' : 'bg-gray-200'}`}
                                    >
                                        {item.question}
                                        {
                                            faqIndex1 === index ?
                        ...
                        <ul className='flex flex-col gap-y-4'>
                            {
                                faq2.map((item, index) => <li key={index}>
                                    <button
                                        ...
                                        className={`text-start flex items-center justify-between w-full text-gray-600 text-xl font-medium py-4 px-5 hover:text-gray-200 hover:bg-[#021D40] duration-300 ${faqIndex2 === index ? 'bg-[#021D40] text-gray-200' : 'bg-gray-200'}`}
                                    >
                                        {item.question}
                                        {
                                            faqIndex2 === index ?
