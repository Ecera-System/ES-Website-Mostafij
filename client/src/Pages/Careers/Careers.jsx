        ...
        <section className='2xl:w-[1100px] lg:w-4/5 w-11/12 mx-auto py-14 flex md:flex-row flex-col items-start md:gap-0 gap-10'>
            ...
            <div className='md:w-4/6 w-full'>
                ...
                <h4 className='text-lg font-medium text-gray-500 my-5'>
                    Join our dynamic team of technology professionals and be part of innovative projects that shape the future of IT solutions.
                </h4>
                
                <div className='bg-white rounded-lg shadow-lg p-8 mb-8'>
                    <h2 className='text-2xl font-bold text-gray-800 mb-4'>Software Engineer</h2>
                    
                    <p className='text-base text-gray-500 mb-4'>
                        Software Engineer responsibilities include gathering user requirements, defining system 
                        functionality, and writing code in various programming languages such as Java, Ruby on Rails, 
                        or .NET technologies (e.g., C++ or JScript.NET). The ideal candidate is well-versed in the 
                        software development life cycle (SDLC), from initial system analysis through testing and 
                        deployment. The Software Engineer is expected to develop high-quality, innovative, and fully 
                        functional software in compliance with coding standards and technical design.
                    </p>
                    
                    <p className='text-base text-gray-500 mb-6'>
                        The role includes executing the full software development life cycle, creating flowcharts, 
                        layouts, and documentation to identify solutions, writing efficient and testable code, and 
                        integrating components into a complete software system. Responsibilities also encompass 
                        developing verification plans, maintaining software functionality, troubleshooting issues, and 
                        deploying systems with user feedback consideration. Candidates must ensure all software 
                        remains compliant with industry standards and up to date with the latest features.
                    </p>
                    
                    <div className='grid md:grid-cols-2 gap-8'>
                        <div>
                            <h4 className='text-xl font-semibold text-gray-800 mb-4'>Responsibilities</h4>
                ...
                <p className='text-base text-gray-500 mb-3'>
                    We are always looking for talented individuals to join our team. If you don't see a position that matches your skills, 
