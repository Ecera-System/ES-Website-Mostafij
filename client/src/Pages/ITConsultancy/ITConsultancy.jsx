...
const ITConsultancy = () => {
    ...
    return (<>
                ...
                <Slider {...settings}>
                    {
                        slide.map(item => <div key={item.title}>
                            <div className='border-2 rounded-md p-6 mx-3'>
                                <img src={item.img} alt="" className='w-[160px] h-auto mx-auto' />
                                <h1 className='text-center text-lg font-medium text-gray-500 mt-3'>
                                    {
                                        item.title
                                    }
                                </h1>
        ...
        <section className='py-16'>
            <div className='w-4/5 mx-auto grid grid-cols-2 items-center gap-x-12'>
                <div>
                    <img src={it5} alt="" className='w-full h-[450px] rounded-lg' />
                </div>
                <div>
                    <h2 className='text-3xl italic font-mono font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500'>
        ...
        <section className='py-16 bg-gray-50'>
            ...
            <div className='w-[85%] mx-auto grid grid-cols-4 items-center gap-x-6 mt-10'>
        ...
        <section className='py-16'>
            <div className='w-4/5 mx-auto grid grid-cols-2 items-center gap-x-12'>
                <div>
                    <img src={st2} alt="" className='w-full h-[450px] rounded-lg' />
                </div>
                <div>
                    <h2 className='text-3xl italic font-mono font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500'>
                        Reach the talent on global level with IT Staffing Services
        ...
        <section className='py-20'>
            <div className='w-4/5 mx-auto grid grid-cols-4 items-center gap-x-10'>
        ...
        <section className='py-16 bg-gray-50'>
            ...
            <div className='w-4/5 mx-auto grid grid-cols-2 gap-6 mt-8'>
                <div>
        ...
        <section className='py-16'>
            ...
            <div className='w-[85%] mx-auto grid grid-cols-3 gap-10 mt-10'>
            ...
            <div className='w-full bg-violet-50 py-16 mt-20 text-violet-900'>
                <div className='w-3/5 mx-auto'>
                    ...
                    <p className='text-center text-2xl font-medium italic leading-relaxed mt-5'>
                        Bill M.
                    </p>
                </div>
            </div>
