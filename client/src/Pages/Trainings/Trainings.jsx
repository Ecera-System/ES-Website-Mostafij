    ...
    <>
      ...
      <section className="text-center bg-gradient-to-r from-violet-700 to-blue-600">
        <header className="w-full h-[72px] text-gray-600">
          <nav
            className={`w-full flex items-center justify-between lg:px-14 px-5 py-2 duration-300 ease-out ${
              scroll
                ? "fixed left-0 top-0 z-50 bg-white shadow-md"
          ...
          >
            ...
            <ul className="hidden lg:flex items-center gap-x-8 text-base font-medium">
              <li
                className={`py-4 cursor-pointer duration-300 relative group/services ${
              ...
              <li
                className={`py-4 cursor-pointer duration-300 relative group/packages ${
                  scroll ? "hover:text-blue-600" : "hover:text-blue-400"
                }`}
              >
            ...
            {/* Side Menu */}
            <aside
              className={`lg:hidden w-full h-full fixed top-0 ${
                openMenu ? "right-0" : "-right-[1024px]"
              } z-50 duration-300 ease-linear bg-black/50`}
            >
        ...
        <div className="md:py-20 py-10 md:w-3/4 w-11/12 mx-auto">
          ...
          <div className="text-gray-100 md:text-lg text-base tracking-wide md:pt-10 pt-5 pb-5">
            <p>Build new web application through most versatile tech stack :</p>
            <p>MongoDB, ExpressJS, ReactJS, NodeJS (MERN stack)</p>
          </div>
          <div className="flex md:flex-row flex-col items-center justify-center gap-5 md:mt-10 mt-5">
            <button className="md:w-max w-full py-3 px-8 border-2 border-white text-white hover:text-blue-700 hover:bg-white duration-300 text-lg font-medium tracking-wide rounded">
              Enroll Now
            </button>
            <button className="md:w-max w-full py-3 px-8 border-2 border-white text-white hover:text-blue-700 hover:bg-white duration-300 text-lg font-medium tracking-wide rounded">
              Download Curriculum
      ...
      <section className="py-20">
        <div className="lg:w-3/5 md:w-4/5 w-11/12 mx-auto text-center">
          ...
          <p className="text-lg text-gray-500 mt-5">
            Start learning web development from basics of HTML, CSS, Javascript.
            After these , learn latest technologies like MongoDB, Express,
            React, & Node. Also get hands on Github & VS Code .
          </p>
          <div>
            <Slider {...settings}>
          ...
          <div className="xl:w-4/5 lg:w-11/12 w-4/5 mx-auto grid lg:grid-cols-5 md:grid-cols-3 grid-cols-1 md:gap-6 gap-10 py-10 rounded-xl">
            <div className="text-center">
              ...
              <p className="text-sm text-blue-700">
                Working from anywhere other than the office, which can be your
                home or just a coworking space.
              </p>
            </div>
            <div className="text-center">
              <span className="text-5xl text-cyan-500">
              ...
              <p className="text-sm text-blue-700">
                Stand-up meetings are regularly held gather daily during which
                team members share status reports on their work
              </p>
            </div>
            <div className="text-center">
              <span className="text-5xl text-cyan-500">
              ...
              <p className="text-sm text-blue-700">
                Encourage the students to clear their doubts after discussion,
                so that their actual performance is not affected.
              </p>
            </div>
            <div className="text-center">
              <span className="text-5xl text-cyan-500">
              ...
              <p className="text-sm text-blue-700">
                Get professionals in your field, showing your demonstrated
                commitment to understand and excelling in your profession.
              </p>
            </div>
            <div className="text-center">
              <span className="text-5xl text-cyan-500">
              ...
              <p className="text-sm text-blue-700">
                Begin with a 7 day free trial, which lets you try a
                Specialization for free & try a paid learning program for free.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-10">
        ...
        <div className="lg:w-4/5 w-11/12 mx-auto my-10 text-center">
          <button className="text-lg font-medium bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-cyan-500 hover:to-blue-600 text-white py-3 px-8 shadow-[5px_8px_10px_0px_rgba(0,0,0,0.3)] rounded-lg">
            Book Your Trial
          </button>
        </div>
      </section>
      <section className="">
        <div className="w-full text-center">
          <a
            href="#"
            className="text-blue-600 text-3xl font-semibold underline"
          >
            AGILE METHODOLOGY
          </a>
        </div>
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-10 gap-5 items-center">
              ...
              <div>
                <p className="text-lg font-medium text-gray-600">
                  An agile software development process always starts by
                  defining the users for a particular product and documenting a
                  vision statement for the scope of problems, opportunities, and
                  values to be addressed. The product owner captures this vision
                  and works with a multidisciplinary team (or teams) to deliver
                  on it. Several roles are involved in an agile development
                  process.
                </p>
              </div>
            </div>
            <div className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-8 mt-10">
              <div>
                ...
                <p className="text-base text-gray-600 sm:mt-5 mt-3">
                  It help teams discuss the status of user stories; teammates
                  share their daily goals, and anyone can escalate blocks that
              ...
              <div>
                ...
                <p className="text-base text-gray-600 sm:mt-5 mt-3">
                  It is where the product owner shares priorities.Tasks are
                  build and assigned to each members, and discusses on how to
                  complete them.
                </p>
              </div>
              <div>
                ...
                <p className="text-base text-gray-600 sm:mt-5 mt-3">
                  The team discusses what went well and what needs improvement
                  in their agile and software development processes.
                </p>
              </div>
              <div>
                <h2 className="text-lg font-medium text-gray-700 text-center">
                ...
                <p className="text-base text-gray-600 sm:mt-5 mt-3">
                  Demo meetings at the end of the sprint, where the
                  functionality is shown to the product owner to gain acceptance
                  on completed work.
                </p>
              </div>
            </div>
          ...
          <div className="bg-slate-200 rounded-xl flex justify-center py-10 px-5">
            <div className="flex md:flex-row flex-col justify-center gap-3">
              <div className="text-gray-700 text-center">
                <h4 className="text-lg font-bold">93%</h4>
                <p>placed within 8 months of graduation</p>
              </div>
              <div className="h-full w-px bg-gray-400"></div>
              <div className="text-gray-700 text-center">
                <h4 className="text-lg font-bold">3 LPA</h4>
                <p>average dream job CTC</p>
              </div>
              <div className="h-full w-px bg-gray-400"></div>
              <div className="text-gray-700 text-center">
                <h4 className="text-lg font-bold">6 LPA</h4>
                <p>average super-dream job CTC</p>
              </div>
              <div className="h-full w-px bg-gray-400"></div>
              <div className="text-gray-700 text-center">
                <h4 className="text-lg font-bold">89%</h4>
        ...
        <div className="xl:w-4/5 lg:w-11/12 sm:w-4/5 w-11/12 mx-auto grid lg:grid-cols-2 grid-cols-1 items-center">
          ...
          <div>
            <img
              src={trophy}
              alt=""
              className="w-full h-auto rounded-xl shadow-[5px_10px_15px_rgba(0,0,0,0.3)]"
            />
          </div>
        </div>
      </section>
          ...
          <div className="xl:w-4/5 lg:w-11/12 md:w-3/4 w-11/12 mx-auto grid lg:grid-cols-2 grid-cols-1 items-center">
            ...
            <div className="lg:pl-10">
              <form className="flex flex-col gap-y-3">
                ...
                <div>
                  <button className="sm:w-max w-full bg-gradient-to-r from-pink-600 to-pink-200 hover:from-pink-200 hover:bg-pink-600 mt-3 py-2 px-10 text-lg font-medium text-white rounded">
                    Submit
                  </button>
                </div>
              </form>
