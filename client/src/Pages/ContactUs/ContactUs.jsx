...
const ContactUs = () => {
    ...
    return (<>
        ...
        <div>
            ...
            <section className='my-16 sm:w-4/5 w-[95%] md:px-8 md:py-12 py-10 px-5 mx-auto border-[3px] border-cyan-500 rounded-xl relative'>
            ...
            <section className='pb-10' >
                <div className='lg:w-4/5 md:w-3/5 sm:w-4/5 w-[92%] mx-auto grid lg:grid-cols-2 grid-cols-1 items-center gap-y-10'>
                    <ul className='flex flex-col gap-5'>
                        <li>
                            <h2 className='text-2xl font-medium  text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-cyan-500'>
                                Email Addresses
                            </h2>
                        </li>
                        <li className='flex items-center gap-x-2 font-medium'>
                            <span>General Inquires</span> -
                            <a href="mailto:info@ecerasystem.com" className='text-blue-700 font-normal'>
                                info@ecerasystem.com
                            </a>
                        </li>
                        <li className='flex items-center gap-x-2 font-medium'>
                            <span>Jobs</span> -
                            <a href="mailto:careers@ecerasystem.com" className='text-blue-700 font-normal'>
                                careers@ecerasystem.com
                            </a>
                        </li>
                        <li className='flex items-center gap-x-2 font-medium'>
                            <span>Sales and Services</span> -
                            <a href="mailto:sales@ecerasystem.com" className='text-blue-700 font-normal'>
                                sales@ecerasystem.com
                            </a>
                        </li>
                    </ul>
                    <div>
                        ...
                        <h1 className='text-center md:text-4xl text-3xl font-medium  text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500'>
                            Office Locations
                        </h1>
                    ...
                    {/* <div>
                        <h2 className='text-2xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-cyan-500'>Write Us</h2>
                        <p className='text-base text-gray-500 mt-2'>
                            Any question? Reach out to us and we’ll get back to you shortly.
                        </p>
                        <form className='mt-5 text-gray-500'>
                            <label
                                htmlFor='name'
